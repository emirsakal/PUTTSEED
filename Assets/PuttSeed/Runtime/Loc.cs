...
namespace PuttSeed.Unity
{
    ...
    public static class Loc
    {
        ...
        public static readonly Dictionary<string, string> Turkish = new Dictionary<string, string>
        {
            ...
            ["Domino"] = "Domino",
            ["Par {0} · {1}"] = "Par {0} · {1}",
            ["This course could not be loaded."] = "Bu kurs yüklenemedi.",
            ["New hole is ready!"] = "Yeni delik hazır!",
            ["Replay code on the clipboard · open ›"] = "Panoda tekrar kodu var · aç ›",
            ["Gauntlet · resume {0}/7"] = "Gauntlet · devam {0}/7",
