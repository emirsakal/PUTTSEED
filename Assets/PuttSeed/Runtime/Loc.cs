...
namespace PuttSeed.Unity
{
    ...
    public static class Loc
    {
        ...
        public static readonly Dictionary<string, string> Turkish = new Dictionary<string, string>
        {
            ...
            ["daily"] = "günlük",
            ["dailies"] = "günlük",
            ["three-star daily"] = "üç yıldızlı günlük",
            ["three-star dailies"] = "üç yıldızlı günlük",
            ["practice course"] = "antrenman kursu",
            ["practice courses"] = "antrenman kursu",
            ["hole #{0} · proven solvable in {1}"] = "delik #{0} · {1} vuruşta çözülebilirliği kanıtlı",
            ["this run is stored in {0} characters"] = "bu tur {0} karakterde saklı",
            ["Motion"] = "Hareket",
            ["Full"] = "Tam",
            ["Reduced"] = "Azalt",
            ["Icy day"] = "Buzlu gün",
