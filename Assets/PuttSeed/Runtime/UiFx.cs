...
namespace PuttSeed.Unity
{
    ...
    public static class UiFx
    {
        ...
        /// <summary>
        /// Activates a chip sliding up into place while fading in. Callers
        /// must reset the chip to its rest position before re-triggering and
        /// stop the returned coroutine (the slide offsets localPosition).
        /// </summary>
